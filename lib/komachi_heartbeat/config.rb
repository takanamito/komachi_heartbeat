module KomachiHeartbeat
  class Config
    ...
    config_accessor :application_version, :application_name, :db_check_enabled, :db_check_query, :redis_check_enabled, :memcached_check_enabled, :database_class_names, :memcached_server_names, :redis_servers, :worker_stats_enabled, :revision_path

    configure do |config|
      config.application_name = "Unknown"
      config.application_version = "Unknown"
      config.db_check_enabled = true
      config.db_check_query = nil
